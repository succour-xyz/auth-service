...
var _messages2 = require("./../constants/messages");
                        ...
                        _bcrypt["default"]
                          ...
                          .then(function (doMatch) {
                            if (doMatch) {
                              ...
                              res
                                .json({
                                  message: _messages2.ENTER_CORRECT_PASSWORD,
                          ...
                          ["catch"](function (error) {
                            return console.error(
                              _errors.ENCRYPTION_COMPARE_FAIL,
                              error
                            );
                          });
                      } else {
